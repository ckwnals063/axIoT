window.daum = window.daum || {},
    function(a) {
        ...
        var g = [],
            ...
            k = j[j.length - 1].src;
        j = null;
//        var l = ["//s1.daumcdn.net/svc/attach/U03/cssjs/postcode/1471501634021/160818.js"];
        var l = ["/js/map_js_init/160818.js"];
        if (/\/js\/map_js_init\/postcode.v2(\.dev){0,1}(\.update){0,1}\.js\b/.test(k)) {
            var m = d(k);
            "false" !== m.autoload && (b(), h = 2)
        }
        var n = {};
        a.postcode.version = "160818", a.postcode.load = function(a) {
