(function() { /*VERSION:160818*/
    ...
    postcodeUtils.param = function(a) {
        ...
        for (var b = ["version/7", "version/8"], c = 0, d = 0, e = b.length; e > d; d++) - 1 === a.indexOf(b[d]) && c++;
        return c === b.length
            ...
            function a(a) {
                var b = {
                    ...
                    c = {
                        ...
                        animation: a.animation ? "on" : "off",
                        shorthand: a.shorthand ? "on" : "off",
